...
-- Q.2 Display the total SNUM, Average, SNUM, MAX SNUM, MIN SNUM of Orders Table
...
-- 8) Display the customer number and name of the customer who has placed an order of amount 686.91
...
-- 10) Display the Order Number where the Customer has placed maximum amount Order
